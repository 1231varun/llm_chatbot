...
# def train_model(data_file, model_save_path, epochs=30, batch_size=2, lr=5e-5):
...
#     dataset = QADataset(data, pad_token_id)
...
#     train_model("preprocessed_data.pkl", "my_gpt2_model")
